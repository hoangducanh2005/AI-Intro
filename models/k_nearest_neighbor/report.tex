...
\begin{itemize}
    ...
    \item \textbf{Tự động hóa trích xuất đặc trưng:} Xây dựng thành công quy trình BPSO để tự động sàng lọc và xác định được tập hợp các chỉ số y tế thực sự có ý nghĩa quyết định đối với bệnh tiểu đường, giảm thiểu s


\chapter{Mô hình phân lớp K-Nearest Neighbors}
